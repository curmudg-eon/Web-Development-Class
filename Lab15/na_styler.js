...
function setStyles() {
  ...
  document.styleSheets[document.styleSheets.length - 1].insertRule(
    "figure#styleThumbs {position: absolute; left: 0px; bottom: 0px;}", 0);

  document.styleSheets[document.styleSheets.length - 1].insertRule(
    "figure#styleThumbs img {outline: 1px solid black; cursor: pointer; opacity: 0.75;}", 1);
    
  document.styleSheets[document.styleSheets.length - 1].insertRule(
    "figure#styleThumbs img:hover {outline: 1px solid red; opacity: 1.0;}", 2);
}
